...
'별들에게 물어봐!'는 AI 기반 별자리 운세 안내 웹 서비스입니다. <br>
평소 아침마다 별자리 운세를 확인하는 습관에서 아이디어를 얻어, React와 Claude API 연동 학습을 겸해 시작하게 된 개인 프로젝트입니다. <br><br>
사용자가 이름과 생년월일을 입력하면 함수로 별자리를 판별하고, 해당 별자리 정보를 Claude API에 전달해 오늘의 운세와 행운 아이템을 응답받아 화면에 출력합니다. <br>
결과 화면은 이미지로 저장해 여러 사람과 공유할 수 있도록 했습니다.
